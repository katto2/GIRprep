...
# I-O data_group
##load I-O data (Group)
IO_group=read.csv("IO_group_1202.csv",header=T, as.is=T)
...
# I-O data_group
##load I-O data (Group)
IO_BR=read.csv("IO_B_1202.csv",header=T, as.is=T)
...
GHG_model=read.csv(file="GHG_model_p_1202.csv",header=T,as.is=T)
...
GHG_GR=read.csv(file="GHG_GR_p_1202.csv",header=T, as.is=T)
...
GHG_BR=read.csv(file="GHG_BR_p_1202.csv",header=T, as.is=T)
...
write.csv(SAM_model_ng,file="b_sam_36_ng_1202.csv")
write.csv(SAM_gr_ng,file="b_sam_group_ng_1202.csv")
write.csv(SAM_br_ng,file="b_sam_br_ng_1202.csv")


write.csv(SAM_model,file="b_sam_36_g_1202.csv")
write.csv(SAM_gr,file="b_sam_group_g_1202.csv")
write.csv(SAM_br,file="b_sam_br_g_1202.csv")

write.csv(SAM_model_ng_pos,file="b_sam_36_ng_pos_1202.csv")
write.csv(SAM_model_k5,file="b_sam_36_g_pos_1202.csv")