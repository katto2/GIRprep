...
GHG_37_0=aggregate(T_GHG_37_name[,2:5],list(T_GHG_37_name$sector_row),FUN=sum)
...
write.csv(GHG_model_p, file="GHG_model_p_1202.csv")
write.csv(GHG_BR_p,file="GHG_BR_p_1202.csv")
write.csv(GHG_GR_p,file="GHG_GR_p_1202.csv")