Gen_CO2=function(EB_G,CF,RowName,IO_Domestic,IO_Import,IO_whole,EC,Oil.Data,YR){
...
index1=c(2,5)#Anthracite(30)/Bituminous.coal(31)
index2=c(23,10,16,11,12) #Naphta(133)/Gasoline(134)/Jet.Oil(135)/Kerosene(136)/Light.oil(137)
index3=13:15 #B.A+B.B+B.C = Heavy.Oil (138)
index4=c(19,26) #Liqufied.petroleum.gas(139)/Lubricants(140)
index5=28:29 #PetroCoke+OtherProd = Misc.petroleum.refinery. products(141)
index6=c(31,35) #Manufactured.gas.supply(302)/Steam.and.hot.water.supply(303)
