...
# Emission Factor and sinking rate
...
#E.Demand_Crude_Stock_d=-1*(7244-10723)/7.33
...
#E.Demand_Crude_domestic = 321/7.33
...
#### Wa assume that P_con=E.Demand_Crude_petroprod
...
#E.Demand_IO.a=c(E.Demand_total[index1.alt],E.Demand_Crude,E.Demand_total$LNG,E.Demand_Coalbriquette,E.Demand.Other_c,E.Demand_total[index2.alt],sum(E.Demand_total[index3.alt]),E.Demand_total[index4.alt],sum(E.Demand_total[index5.alt]),E.Demand_total$Hydro,(E.Demand_total$Elect*Elect.Fire),E.Demand_total$Nuclear,(E.Demand_total$Elect*Elect.Other),E.Demand_total[index6.alt]) 
#E.Demand_IO.a=data.frame(E.Demand_IO.a)
### Provide col names
IO_name=colnames(IO_whole)
colnames(E.Demand_IO)=IO_name[index_IO]
#colnames(E.Demand_IO.a)=IO_name[index_IO]
### Save as k*1 matrix
